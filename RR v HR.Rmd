...
# REVISED FOR MORE CLINICAL MEANING
...
# For manuscript
#bitmap("Cumulative Incidence_Years.tiff",width=140, height=100, units='mm',type='tifflzw',res=600)
# For poster
...
summary_tibble %>% 
  ...
  ggplot(aes(x = time_365, y = risk, color = trt, linetype=trt)) +
    ...
    labs(
      ...
      color = "",
      linetype = "",
      title = "Cumulive Incidence Curve via Kaplan-Meier Estimator"
    ) +
  ...
  geom_segment(x = 0, xend = 3.5, y = 0.5, yend = 0.5, color = "darkgrey", 
               lty = "dashed", linewidth = 0.25) +
  annotate("text", 
           x=c(0.85, 1.35, 2.25, 3.23
               #, 2
               ),
...
# For manuscript
#bitmap("Cumulative Incidence.tiff",width=140, height=100, units='mm',type='tifflzw',res=600)
# For poster
# bitmap("Cumulative Incidence_Poster.tiff", width=14, height=7.5, units="in", type='tifflzw',res=600)
# plot(km, 
#      fun = function(x) 1-x,
#      lty = c("solid", "dashed"), 
#      #col = c("#56B4E9","#D55E00"), 
#      xlab = "Time From the Beginning of Follow-up (Days)",
...
#      lwd = 2.5,
#      mark.time = T)
# abline(v=365/365, lty="dashed")
# abline(v=730/365, lty="dashed")
# abline(v=1095/365, lty="dashed")
# text(x=200, y=0.08, paste("RR = ", rr90), cex=2)
# text(x=740, y=0.7, paste("RR = ", rr630), cex=2)
# text(x=1100, y=0.85, paste("RR = ", rr990), cex=2)
...
segments(x0=0,x1=180/365, y0= 0.000, y1=0.000, lwd=1.5, lty="dashed", col="red")
segments(x0=0,x1=365/365, y0= 0.04, y1=0.04, lwd=1.5, lty="dashed", col="red")
segments(x0=0, x1=730/365, y0=0.09, y1 = 0.09, lwd=1.5, lty="dashed", col="red")
segments(x0=0, x1=1095/365, y0=0.14, y1=0.14, lwd=1.5, lty="dashed", col="red")
legend(1.93, 1.45, c("Chemo Only","Panitumumab+Chemo"), 
       lty = c("solid","dashed"),
       cex = 0.7,
       lwd=2,
       bty = "n")
text(x=0.8, y=0.0, paste("PH HR=", hr180), cex = 0.9)
text(x=1.3, y=0.05, paste("PH HR=", hr365), cex = 0.9)
text(x=2.3, y= 0.1, paste("PH HR=",hr730), cex = 0.9)
text(x=2.75, y= 0.19, paste("PH HR=", hr1095), cex = 0.9)
segments(x0=180/365, x1=180/365, y0=0.4, y1=1.38, lty="dotted")
segments(x0=365/365, x1=365/365, y0=0.75, y1=1.38, lty="dotted")
segments(x0=730/365, x1=730/365, y0=0.4, y1=1.38, lty="dotted")
segments(x0=1095/365, x1=1095/365, y0=0.4, y1=1.38, lty="dotted")
text(x = 0.77, y=0.65, paste("KS HR=", round(h180,2)), cex = 1)
text(x = 1.27, y=0.8, paste("KS HR=", round(h365,2)), cex = 1)
text(x = 2.27, y=0.5, paste("KS HR=", round(h730,2)), cex = 1)
text(x = 2.73, 0.8, paste("KS HR=", round(h1095,2)), cex = 1) # previously: x=1052
...
interaction <- coxph(Surv(years,event) ~ trt + tt(trt), data = mCRC, ties = "efron", tt = list(function(trt, years, ...){trt*years>700/365}))
