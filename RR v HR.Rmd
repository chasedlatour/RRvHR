...
legend(1.93, 1.43, c("Chemo Only","Panitumumab+Chemo"), 
       ...
       lwd=2,
       bty = "n")
text(x=0.74, y=0.0, paste("PH HR=", hr180), cex = 0.9)
text(x=1.25, y=0.05, paste("PH HR=", hr365), cex = 0.9)
text(x=2.25, y= 0.1, paste("PH HR=",hr730), cex = 0.9)
text(x=2.75, y= 0.20, paste("PH HR=", hr1095), cex = 0.9)
...
text(x = 0.74, y=0.65, paste("KS HR=", round(h180,2)), cex = 0.9)
text(x = 1.25, y=0.8, paste("KS HR=", round(h365,2)), cex = 0.9)
text(x = 2.25, y=0.5, paste("KS HR=", round(h730,2)), cex = 0.9)
text(x = 2.75, 0.8, paste("KS HR=", round(h1095,2)), cex = 0.9) # previously: x=1052
